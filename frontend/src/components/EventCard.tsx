...
export const EventCard: React.FC<EventCardProps> = ({ event, searchTerm }) => {
  ...
  return (
    <Link to={`/events/${event.id}`}>
      <div className="relative h-80 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 cursor-pointer group">
        {/* Background Image */}
        <div 
